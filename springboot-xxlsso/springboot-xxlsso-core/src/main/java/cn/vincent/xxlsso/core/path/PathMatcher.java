package cn.vincent.xxlsso.core.path;
 ...
 *
 * <p>The default implementation is {@link cn.vincent.xxlsso.core.path.impl.AntPathMatcher}, supporting the Ant-style pattern syntax.		(borrowed from spring)
 */
