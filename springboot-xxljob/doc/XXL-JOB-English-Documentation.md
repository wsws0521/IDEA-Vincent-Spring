...
<context:component-scan base-package="cn.vincent.xxljob.executor.service.jobhandler" />

<!-- configure 02、Excutor：executer core configure -->
<bean id="xxlJobExecutor" class="cn.vincent.xxljob.core.executor.XxlJobExecutor" init-method="start" destroy-method="destroy" >
...
#### Step 1:develp obHandler in the executor project
    - 1, create new java class implent cn.vincent.xxljob.core.handler.IJobHandler;
...
```
xxl-job-admin#cn.vincent.xxljob.admin.controller.JobApiController.callback
```
...
The scheduling center API service location: cn.vincent.xxljob.core.biz.AdminBiz.java

The scheduling center API service requests reference code：cn.vincent.xxljob.adminbiz.AdminBizTest.java
